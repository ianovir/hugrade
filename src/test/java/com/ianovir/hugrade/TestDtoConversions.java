...
public class TestDtoConversions {
    ...
    public void test_GraphDto_to_Graph() {
        ...
        assertEquals(g.getEdgeMu(), g.getEdgeMu());
        assertEquals(g.getNodeMu(), g.getNodeMu());
        assertEquals("Node3", g.getNodes().get(2).getName());
        assertEquals(5, g.getNodes().get(2).getX());
        assertEquals(6, g.getNodes().get(2).getY());
        assertEquals(5, g.getEdges().get(1).getWeight());
        assertEquals(1, g.getEdges().get(1).getSource());
